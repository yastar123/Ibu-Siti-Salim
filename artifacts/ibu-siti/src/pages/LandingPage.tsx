    ...
    <div className="min-h-screen bg-[#faf8f6] overflow-x-hidden">
      ...
      <section className="relative overflow-hidden" style={{ height: 'clamp(400px, 65vh, 680px)' }}>
        ...
        <div
          ...
          style={{ backgroundImage: `url('/products/seasonal-autumn.png')`, backgroundPosition: 'center 25%' }}
        />
      ...
      {/* ══════════════════════════════════
          STATS BAR
      ══════════════════════════════════ */}
      <div className="bg-[#8b7355] py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
            {stats.map((s, i) => (
              <div key={i} className="reveal" style={{ '--delay': `${i * 80}ms` } as React.CSSProperties}>
