...
import { Heart, Search, ShoppingCart, Menu, X, MessageCircle, ChevronDown, Star, Clock, ChevronUp } from 'lucide-react'
...
export default function LandingPage() {
  ...
  const whatsappNumber = '62812345678' // Ganti dengan nomor WhatsApp Anda
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredProducts.map((product, idx) => (
              <div 
                ...
                style={{ animationDelay: `${idx * 100}ms` }}
              >
                <div className="relative bg-muted rounded-2xl overflow-hidden h-64 mb-4 flex items-center justify-center shadow-sm group-hover:shadow-premium transition-smooth cursor-pointer" onClick={() => handleProductClick(product)}>
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-accent/10 group-hover:from-primary/20 group-hover:to-accent/20 transition-smooth" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm opacity-75">
                <li>
                  <a href="#categories" onClick={closeMobileMenu} className="hover:opacity-100 transition-smooth">
                    Gaun Pengantin
                  </a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm opacity-75">
                <li>
                  <a href="#products" onClick={closeMobileMenu} className="hover:opacity-100 transition-smooth">
                    Sewa Baju
                  </a>
                </li>
                <li>
          ...
          <div className="border-t border-primary-foreground/20 pt-8">
            <div className="flex flex-col sm:flex-row items-center justify-between text-sm opacity-75 gap-6">
              ...
              <div className="flex gap-6">
                <a href="#" className="hover:opacity-100 transition-smooth font-medium">
                  Instagram
                </a>
                <a href="#" className="hover:opacity-100 transition-smooth font-medium">
                  Facebook
